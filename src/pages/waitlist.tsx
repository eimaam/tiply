...
const WaitlistPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <Container className="w-full bg-gradient-to-br from-brand-primary/20 to-brand-accent/20 p-8 md:p-12 flex items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-5">
            <div className='flex items-center justify-center mb-0'>
              <img src={logo} alt="tiply Logo" className="h-20 md:h-24 w-auto" />
          ...
          <motion.div variants={itemVariants} className="mb-10">
            ...
            <p className="text-lg text-brand-muted-foreground mb-6">
              Tipping without the Friction! Instantly get tips in USDC! <br /> Built on <code>Solana</code> for speed and security.
            </p>
      ...
      <Container >
        ...
        >
          <motion.div variants={itemVariants} className="mb-10">
            <h2 className="text-center text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-brand-primary to-brand-accent text-transparent bg-clip-text">
              Join Our Waitlist 🚀
            </h2>
            <p className="text-brand-muted-foreground">
              Be the first to know when we launch. Tiply's changing how creators get paid and how supporters show love.
            </p>
          </motion.div>
            ...
            <div className="bg-gradient-to-br from-brand-primary/5 to-brand-accent/5 rounded-xl border border-brand-border p-6 backdrop-blur-sm">
              ...
              {isSubscribed ? (
                ...
                >
                  ...
                  <p className="text-brand-muted-foreground">
                    We've added you to our waitlist. Keep an eye on your inbox for updates as we get closer to launch.
                  </p>
                </motion.div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4 w-full">
                  ...
                  <p className="text-xs text-center text-brand-foreground">
                    We'll only email you about tiply launches and important updates. No spam, promise!
                  </p>
                </form>
              )}
            </div>
          ...
          <motion.div variants={itemVariants} className="pt-10 text-center text-sm text-brand-muted-foreground">
